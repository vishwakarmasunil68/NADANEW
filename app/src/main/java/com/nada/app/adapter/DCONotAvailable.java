...
public class DCONotAvailable extends RecyclerView.Adapter<DCONotAvailable.ViewHolder> {

    private List<DCODeputeUserPOJO> items;
    Activity activity;
    Fragment fragment;


    public DCONotAvailable(Activity activity, Fragment fragment, List<DCODeputeUserPOJO> items) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_dco_not_available, parent, false);
