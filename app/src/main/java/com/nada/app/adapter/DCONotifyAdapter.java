...
public class DCONotifyAdapter extends RecyclerView.Adapter<DCONotifyAdapter.ViewHolder> {

    public List<DCODeputeUserPOJO> items;
    Activity activity;
    Fragment fragment;

    public DCONotifyAdapter(Activity activity, Fragment fragment, List<DCODeputeUserPOJO> items) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_dco_notify_item, parent, false);
